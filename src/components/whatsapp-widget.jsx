    ...
    return (
        <>
            ...
            <motion.button
                ...
                className="fixed bottom-8 right-8 z-40 bg-green-500 text-white p-4 rounded-full shadow-2xl shadow-green-500/30 hover:bg-green-600 transition-colors group"
                    ...
                    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6">
                        ...
                        >
                            <div className="p-8 text-center">
                                ...
                                <p className="text-slate-500 dark:text-slate-400 mb-8 text-sm">Scan the QR code below to start a conversation with me directly.</p>

                                <div className="bg-white p-4 rounded-3xl shadow-inner inline-block mb-8 border border-slate-100">
                                    <img
                                        src={bio.whatsappQR}
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-center gap-2 text-xs font-mono text-slate-400 uppercase tracking-widest">
                                    ...
                                    <p className="text-slate-400 dark:text-slate-500 text-xs">
                                        Available for freelance and professional opportunities.
                                    </p>
                                </div>
                            </div>

                            <div className="bg-slate-50 dark:bg-slate-800/50 p-4 text-center border-t border-slate-100 dark:border-slate-800">
                                <span className="text-[10px] text-slate-400 uppercase tracking-tighter">Fast response guaranteed</span>
                            </div>
                        </motion.div>
                    </div>
                )}
